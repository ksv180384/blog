...
@push('scripts')
    ...
    <script src="{{ asset('js/blog/post/create.js') }}"></script>
@endpush
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data" id="formPostCreate">
                                    @csrf

                                    <div class="list-group list-group-unbordered mb-3">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-lg-3 min-h-240">
                                                <div class="add-post-img js-post-img" style="background-image: url('/img/no-image.png');">
